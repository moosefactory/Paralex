...
Pod::Spec.new do |s|
	...
	s.description      = <<-DESC
        Paralex is a cross-platofrm (iOS/MacOS) Utility Library to declare an identifiers and parameters lexicon.
					   DESC
	s.homepage         = "https://github.com/moosefactory/Paralex.git"
	s.license          = 'MIT'
	s.author           = { "Tristan Leblanc" => "tristan@moosefactory.eu" }
	s.source           = { :git => "git@github.com:moosefactory/Paralex.git", :tag => s.version.to_s }
	...
	s.source_files = 'Sources/Paralex/**/*.swift'
end
